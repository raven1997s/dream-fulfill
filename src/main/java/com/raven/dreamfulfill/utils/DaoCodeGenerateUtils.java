...
public class DaoCodeGenerateUtils {
    ...
    public static void main(String[] args) {
        ...
        String packageOutPath = "com.raven.dreamfulfill.mapper";//指定实体生成所在包的路径
        String serviceName = "";
        String daoSuffix = "Mapper";
        String entitySuffix = "";
        generateEntityCode("t_activity_stat", packageOutPath, daoSuffix, entitySuffix, serviceName);
    }
...
//import cn.igancao.erp.domain.EBizOrgan;
        sb.append("import com.raven.dreamfulfill.domain.entity." + parseName(tablename, entitySuffix) + ";\r\n");
