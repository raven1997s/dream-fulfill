...
//        System.out.println("2022年的节假日: " + getHolidayOfYear("2023"));

        List<HolidayDTO> holidayList = HolidayUtils.getHolidayOfYear(String.valueOf(2023)).toJavaList(HolidayDTO.class);
        List<HolidayDTO> result = new ArrayList<>(holidayList.stream()
