...
public class EntityCodeGenerateUtils {
    ...
    public static final String URL = "jdbc:mysql://rm-cn-zsk3bkvlr000wh2o.rwlb.rds.aliyuncs.com:3306";
    public static final String NAME = "raven";
    public static final String PASSWORD = "hM5ePLsVESJxX3@";
    public static final String DRIVER = "com.mysql.cj.jdbc.Driver";
    public static final String dbName = "dream_fulfill";

    public static void main(String[] args) {

        String packageOutPath = "com.raven.dreamfulfill.domain.entity";//指定实体生成所在包的路径
        String suffix = "";
        String serviceName = "";
        generateEntityCode("t_activity_stat", packageOutPath, suffix, serviceName);
    }
    ...
    public EntityCodeGenerateUtils(Connection con, String tableName, String packageOutPath, String suffix, String serviceName) {
        ...
        try {
            ...
            try {
                ...
                String outputPath =
                        directory.getAbsolutePath() + "/" + serviceName + "/src/main/java/" + packageOutPath.replace(".", "/") + "/"
